...
T = TypeVar("T", bound="ObjectJsonSchemaProperties")


@attr.s(auto_attribs=True)
class ObjectJsonSchemaProperties:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_json_schema_properties = cls()
        ...
        object_json_schema_properties.additional_properties = additional_properties
        return object_json_schema_properties
