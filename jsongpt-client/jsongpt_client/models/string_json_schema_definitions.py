...
T = TypeVar("T", bound="StringJsonSchemaDefinitions")


@attr.s(auto_attribs=True)
class StringJsonSchemaDefinitions:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        string_json_schema_definitions = cls()
        ...
        string_json_schema_definitions.additional_properties = additional_properties
        return string_json_schema_definitions
