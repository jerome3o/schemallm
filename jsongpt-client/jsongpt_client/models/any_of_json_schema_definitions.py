...
T = TypeVar("T", bound="AnyOfJsonSchemaDefinitions")


@attr.s(auto_attribs=True)
class AnyOfJsonSchemaDefinitions:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        any_of_json_schema_definitions = cls()
        ...
        any_of_json_schema_definitions.additional_properties = additional_properties
        return any_of_json_schema_definitions
