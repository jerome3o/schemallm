...
T = TypeVar("T", bound="NullJsonSchemaDefinitions")


@attr.s(auto_attribs=True)
class NullJsonSchemaDefinitions:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        null_json_schema_definitions = cls()
        ...
        null_json_schema_definitions.additional_properties = additional_properties
        return null_json_schema_definitions
