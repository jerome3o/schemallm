...
if TYPE_CHECKING:
    from ..models.null_json_schema_definitions import NullJsonSchemaDefinitions


T = TypeVar("T", bound="NullJsonSchema")
...
class NullJsonSchema:
    ...
    Attributes:
        ...
        definitions (Union[Unset, NullJsonSchemaDefinitions]):
        type (Union[Unset, SchemaType]): An enumeration. Default: SchemaType.NULL.
    """
    ...
    definitions: Union[Unset, "NullJsonSchemaDefinitions"] = UNSET
    type: Union[Unset, SchemaType] = SchemaType.NULL
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_definitions, Unset):
            ...
            definitions = NullJsonSchemaDefinitions.from_dict(_definitions)
        ...
        null_json_schema.additional_properties = d
        return null_json_schema
