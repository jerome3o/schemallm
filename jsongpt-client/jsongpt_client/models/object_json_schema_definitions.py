...
T = TypeVar("T", bound="ObjectJsonSchemaDefinitions")


@attr.s(auto_attribs=True)
class ObjectJsonSchemaDefinitions:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        object_json_schema_definitions = cls()
        ...
        object_json_schema_definitions.additional_properties = additional_properties
        return object_json_schema_definitions
