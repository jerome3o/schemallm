...
T = TypeVar("T", bound="BooleanJsonSchemaDefinitions")


@attr.s(auto_attribs=True)
class BooleanJsonSchemaDefinitions:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        boolean_json_schema_definitions = cls()
        ...
        boolean_json_schema_definitions.additional_properties = additional_properties
        return boolean_json_schema_definitions
