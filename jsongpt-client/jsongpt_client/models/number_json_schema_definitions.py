...
T = TypeVar("T", bound="NumberJsonSchemaDefinitions")


@attr.s(auto_attribs=True)
class NumberJsonSchemaDefinitions:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        number_json_schema_definitions = cls()
        ...
        number_json_schema_definitions.additional_properties = additional_properties
        return number_json_schema_definitions
