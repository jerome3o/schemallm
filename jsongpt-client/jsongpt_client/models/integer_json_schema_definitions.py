...
T = TypeVar("T", bound="IntegerJsonSchemaDefinitions")


@attr.s(auto_attribs=True)
class IntegerJsonSchemaDefinitions:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        integer_json_schema_definitions = cls()
        ...
        integer_json_schema_definitions.additional_properties = additional_properties
        return integer_json_schema_definitions
